        ...
        <div class="row">
            <div style="padding-bottom: 24px" class="text-center">
                <span class="page-header text-info"  style="font-size: 37px; color: #337ab7;">
                   ...
                   Indicador 2: Porcentaje de análisis procesados por día
                </span>
            </div>
        </div>
        <!-- info row -->
            ...
            <div class="panel box">
                <div id="collapseContactabilidad" class="panel-collapse collapse in" aria-expanded="true" style="">
                    ...
                    <div class="box-footer">
                        <p>OC: Total de análisis registrados</p>
                        <p>NO: Total de análisis con resultado</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div id="collapseContactabilidad" class="panel-collapse collapse in" aria-expanded="true" style="">
                    <div class="box-body">
                        <div class="mailbox-controls">
                            <div class="row">
                                <div class="col-sm-12">
                                    <form action="{{route('indicador.dos')}}" id="form-search" method="get">
                        ...
                        @include('indicador.partials.resultado-dos')
                        <!-- /.table -->
                        </div>
                    </div>
