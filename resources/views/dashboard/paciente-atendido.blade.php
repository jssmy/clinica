        ...
        <div class="row">
            <div style="padding-bottom: 24px" class="text-center">
                <span class="page-header text-info"  style="font-size: 37px; color: #337ab7;">
                    <span class="fa fa-search"></span>Reporte de Pacientes Atendidos
                </span>
            </div>
        </div>
        <!-- info row -->
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <div class="input-group-btn">
                            <button id="btn-consultar"
                                    ...
                                    data-url="{{route('persona.dato.personal',['paciente','numero_documento'])}}"
...
@section('scripts')
    ...
    <script>
        var load_reporte_url="{{route('dashboard.paciente-atendido',['paciente=persona_id'])}}";
        ...
        function load_reporte(){
            var url_temporal =load_reporte_url;

            $.get(url_temporal.replace('persona_id',params.persona.id),function (view) {
