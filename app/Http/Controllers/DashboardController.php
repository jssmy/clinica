...
class DashboardController extends Controller
{
    ...
    public function reporteStockInsumo(){
        ...
        return view('dashboard.stock-insumo',compact('insumos'));
    }
